        ...
        <div className='p-4'>
            ...
            <div className='mt-10 p-2'>
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <button className='active:text-gray-300 transition transform active:scale-90 p-4 rounded w-full text-brand border-none bg-slate-100 text-xl shadow-md'>Admission Status</button>
                </div>
            </div>
        </div>
    )
